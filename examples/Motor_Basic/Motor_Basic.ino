...
void setup() {
  ...
  // If your motor is spinning the wrong way, you can reverse it by calling reverse() on motorA
  // when you initalize it or at any time after.
  //motorA.begin(4,5,6).reverse();
}
